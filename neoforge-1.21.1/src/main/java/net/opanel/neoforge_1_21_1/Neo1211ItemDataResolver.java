...
/**
 * NeoForge 1.21.1 implementation of NeoItemDataResolver.
 * Uses Minecraft 1.20.5+ DataComponents API.
 */
public class Neo1211ItemDataResolver implements NeoItemDataResolver {

    @Override
    public Map<String, Object> resolveExtraData(ItemStack item) {
        // Extra data is handled in serializeItem
        return new HashMap<>();
    }
