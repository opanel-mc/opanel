...
public class Main {
    ...
    private void initInventorySync() {
        InventorySerializer.setResolver(new Forge12111ItemDataResolver());
        inventorySyncTask = new InventorySyncTask(player -> new ForgePlayer(player, player.getServer()), 20);
