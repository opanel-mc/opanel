...
/**
 * Forge 1.21.8 implementation of ItemDataResolver.
 * Same API as 1.21.5+ (getArmor, getOffhandItem methods).
 */
public class Forge1218ItemDataResolver implements ItemDataResolver {
    ...
    @Override
    public String getTargetVersion() { return "1.21.8"; }
}
