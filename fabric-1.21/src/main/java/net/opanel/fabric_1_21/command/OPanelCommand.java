                                        ...
                                        .executes(ctx -> {
                                            ...
                                            if (webServer.isRunning()) {
                                                ctx.getSource().sendFeedback(
                                                        () -> Text.of("Web panel is already started."), false);
                                            } else {
                                                try {
                                                    webServer.start();
                                                    ctx.getSource().sendFeedback(
                        ...
                        .then(
                                literal("stop")
                                        .executes(ctx -> {
                                            ...
                                            if (!webServer.isRunning()) {
                                                ctx.getSource().sendFeedback(
                                                        () -> Text.of("Web panel is already stopped."), false);
                                            } else {
                                                try {
                                                    webServer.stop();
                                                    ctx.getSource().sendFeedback(
                                ...
                                literal("backup")
                                        .executes(ctx -> {
                                            ...
                                            if (backupManager == null || !backupManager.isConfigured()) {
                                                ...
                                                ctx.getSource().sendFeedback(() -> Text.of("§aStarting backup..."),
                                                        false);
                                                ...
                                                backupManager.performBackupAsync(() -> {
                                                    ...
                                                    if (result.isSuccess()) {
                                                        ...
                                                        source.sendFeedback(
                                                                () -> Text
                                                                        .of("§cBackup failed: " + result.getMessage()),
                                                                false);
                                                    }
                                                });
                                            }
