...
public class Fabric12111ItemDataResolver implements ItemDataResolver {
    @Override
    ...
    public Map<String, Object> serializeItem(ItemStack item) {
        ...
        if (item.contains(DataComponentTypes.DAMAGE) && item.contains(DataComponentTypes.MAX_DAMAGE)) {
            ...
            if (damage != null && maxDamage != null) { result.put("durability", maxDamage - damage); result.put("maxDurability", maxDamage); }
        }
