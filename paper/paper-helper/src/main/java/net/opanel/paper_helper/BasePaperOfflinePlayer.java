...
public abstract class BasePaperOfflinePlayer implements OPanelPlayer {
    ...
    protected Path getPlayerDataPath() {
        ...
        Path path = server.getWorlds().get(0).getWorldFolder().toPath().resolve("playerdata/"+ uuid +".dat");
