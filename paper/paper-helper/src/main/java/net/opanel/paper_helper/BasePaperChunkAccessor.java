...
public abstract class BasePaperChunkAccessor implements OPanelChunkAccessor {
    protected final JavaPlugin plugin;

    public BasePaperChunkAccessor(JavaPlugin plugin) {
        this.plugin = plugin;
    }
    ...
    protected Tile readOnMainThread(int chunkX, int chunkZ) {
        ...
        final int minY = PaperUtils.getMinY(world);
        final int maxY = PaperUtils.getMaxY(world);
