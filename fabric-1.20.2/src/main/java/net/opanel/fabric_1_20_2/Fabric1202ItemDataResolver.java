...
public class Fabric1202ItemDataResolver implements ItemDataResolver {
        ...
        if (nbt != null) {
            if (nbt.contains("display")) {
                ...
                if (display.contains("Lore")) {
                    ...
                    for (int i = 0; i < display.getList("Lore", 8).size(); i++) loreList.add(display.getList("Lore", 8).getString(i));
    ...
    @Override
    public String getTargetVersion() { return "1.20.2"; }
}
