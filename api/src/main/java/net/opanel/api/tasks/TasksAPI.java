...
public interface TasksAPI {
     ...
     * @throws net.opanel.api.exception.OperationFailedException if the cron
     ...
     * @throws NullPointerException if an argument or command entry is {@code null}
     * @throws IllegalArgumentException if a required value is blank/empty
     * @throws net.opanel.api.exception.OperationFailedException if the task does
     ...
     * @throws NullPointerException if {@code id} is {@code null}
     * @throws IllegalArgumentException if {@code id} is blank
     * @throws net.opanel.api.exception.OperationFailedException if the task does not exist
     */
