 ...
 * {@link net.opanel.api.exception.ServerUnavailableException} when OPanel has
 * not attached to a server or the server is shutting down. Other platform
 * failures are exposed as {@link net.opanel.api.exception.OperationFailedException}.</p>
 */
public interface ServerAPI {
     ...
     * @throws net.opanel.api.exception.OperationFailedException if the rule is
