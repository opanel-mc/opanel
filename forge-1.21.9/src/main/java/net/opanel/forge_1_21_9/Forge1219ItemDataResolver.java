...
/**
 * Forge 1.21.9 implementation of ItemDataResolver.
 * Same API as 1.21.5+ (getArmor, getOffhandItem methods).
 */
public class Forge1219ItemDataResolver implements ItemDataResolver {
    ...
    @Override
    public String getTargetVersion() { return "1.21.9"; }
}
