...
public class ForgeListener {
    ...
    public void onPlayerJoin(PlayerEvent.PlayerLoggedInEvent event) {
        ...
        EventManager.get().emit(EventType.PLAYER_JOIN, new OPanelPlayerJoinEvent(new ForgePlayer(player, player.getServer())));
    ...
    public void onPlayerLeave(PlayerEvent.PlayerLoggedOutEvent event) {
        if (!(event.getEntity() instanceof ServerPlayer player)) return;
        EventManager.get().emit(EventType.PLAYER_LEAVE, new OPanelPlayerLeaveEvent(new ForgePlayer(player, player.getServer())));
    ...
    public void onPlayerGameModeChange(PlayerEvent.PlayerChangeGameModeEvent event) {
        ...
        EventManager.get().emit(EventType.PLAYER_GAMEMODE_CHANGE, new OPanelPlayerGameModeChangeEvent(new ForgePlayer(player, player.getServer()), opanelGamemode));
    }
    ...
    public void emitInventoryChange(ServerPlayer player) {
        ...
        EventManager.get().emit(EventType.PLAYER_INVENTORY_CHANGE, new OPanelPlayerInventoryChangeEvent(new ForgePlayer(player, player.getServer()), inventoryData));
    }
}
